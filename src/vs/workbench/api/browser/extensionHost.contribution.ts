...
// Norris Writer: IDE surfaces disabled — stubs satisfy MainContext proxies for extension host
import '../../contrib/norrisWriter/browser/norrisWriterMainThreadStubs.js';
