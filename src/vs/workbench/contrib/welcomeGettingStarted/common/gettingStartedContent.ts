...
export const startEntries: GettingStartedStartEntryContent = [
	{
		...
		title: localize('gettingStarted.newFile.title', "New Manuscript..."),
		description: localize('gettingStarted.newFile.description', "Create a new chapter or note."),
	...
	},
	{
		...
		description: localize('gettingStarted.openMac.description', "Open a folder containing your manuscript"),
	...
	},
	{
		...
		description: localize('gettingStarted.openFolder.description', "Open a folder containing your manuscript"),
		icon: Codicon.folderOpened,
		when: '!isWeb && !isMac',
		content: {
			type: 'startEntry',
...
export const walkthroughs: GettingStartedWalkthroughContent = [
	...
	{
		id: 'SetupWeb',
		title: localize('gettingStarted.setupWeb.title', "Get Started with Norris Writer for the Web"),
		description: localize('gettingStarted.setupWeb.description', "Customize your editor and start writing"),
		isFeatured: true,
		icon: setupIcon,
		when: 'isWeb',
		next: 'Beginner',
		walkthroughPageTitle: localize('gettingStarted.setupWeb.walkthroughPageTitle', 'Setup Norris Writer Web'),
		content: {
			type: 'steps',
			steps: [
				{
